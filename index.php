...
<body id="page-top">
        ...
        <ul class="pc-sns">
          <li class="sns-item">
            <a href="https://www.youtube.com/@%E3%81%93%E3%81%93%E3%82%8D%E7%9B%B8%E8%AB%87%E7%A0%94%E4%BF%AE%E3%82%BB%E3%83%B3%E3%82%BF%E3%83%BC/featured" target="_blank" rel="noopener no-referrer" aria-label="YouTube（新しいタブで開きます）">
              <img src="./images/SVG/youtube.svg" width="32" height="32" alt="YouTube公式チャンネル">
            </a>
          </li>
          <li class="sns-item">
            <a href="" target="_blank" rel="noopener no-referrer" aria-label="facebook（新しいタブで開きます）">
              <img src="./images/SVG/facebook.svg" width="32" height="32" alt="facebook公式アカウント">
            </a>
          </li>
          <li class="sns-item">
            <a href="https://www.instagram.com/feel_since2017/" target="_blank" rel="noopener no-referrer"aria-label="instagram（新しいタブで開きます）">
              <img src="./images/SVG/instagram.svg" width="32" height="32" alt="Instagram公式アカウント">
            </a>
          </li>
          <li class="sns-item">
            <a href="https://www.tiktok.com/@feel_since17?_r=1&_t=ZS-91Sf9nEGpXt" target="_blank" rel="noopener no-referrer"aria-label="tik tok（新しいタブで開きます）">
              <img src="./images/SVG/tik_tok.svg" width="32" height="32" alt="tiktok公式アカウント">
            </a>
          </li>
          <li class="sns-item">
            <a href="https://x.com/feel202504?s=11" target="_blank" rel="noopener no-referrer"aria-label="x（新しいタブで開きます）">
              <img src="./images/SVG/x.svg" width="32" height="32" alt="X公式アカウント">
            </a>
          </li>
        </ul>
      </nav>
      <a class="primary-btn" href="#cta" aria-label="無料相談フォームへ移動">
        お問い合わせ
      </a>
      </div>
    </div>
        ...
        <div class="splide__track">
          <div class="splide__list">
            <div class="splide__slide">
              <img class="slider__img" src="./images/children-dash.jpg" width="1920" height="1283" alt="自然の中で元気に体を動かして遊ぶ子どもたちと見守る先生の様子">
              <div class="inner first-slide">
                <h1 class="main-title">今すぐできる<br>具体的な支援を<br class="sp-xs">ご提案</h1>
                <p class="text">気軽に相談できる<br class="sp-xs">心のよりどころに</p>
              </div>
            </div>
            <div class="splide__slide">
              <img class="slider__img" src="./images/family.jpg" width="1920" height="1280" alt="自然の中で家族そろって散歩を楽しむ様子">
              <div class="inner second-slide">
                <p class="text">焦らなくても大丈夫</p>
                <p class="text">ゆっくりのびのび</p>
                <p class="text">その子のペースで</p>
                <p class="text">大きな自信へ</p>
              </div>
            </div>
            <div class="splide__slide">
              <img class="slider__img" src="./images/girl-with-pen.jpg" width="1920" height="1280" alt="集中してお絵かきに取り組む子どもの様子">
              <div class="inner third-slide">
          ...
          <div class="splide__list">
            <div class="splide__slide">
              <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="_レイヤー_1" viewBox="0 0 1105 1060">
                ...
                <image clip-path="url(#clippath1)" mask="url(#fadeMask1)" href="./images/sample.png" width="1105" height="1060"  preserveAspectRatio="xMidYMid meet" />
              </svg>
            </div>
            ...
            <div class="splide__slide">
              <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="_レイヤー_1" viewBox="0 0 1105 1060">
                <defs>
                  ...
                  <image clip-path="url(#clippath2)" mask="url(#fadeMask2)" href="./images/sample2.png" width="1105" height="1060"  preserveAspectRatio="xMidYMid meet" />
              </svg>
            </div>
            ...
            <div class="splide__slide">
              <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="_レイヤー_1"  viewBox="0 0 1105 1060">
                ...
                <image clip-path="url(#clippath3)" mask="url(#fadeMask3)" href="./images/sample3.png" width="1105" height="1060"  preserveAspectRatio="xMidYMid meet"/>
              </svg>
            </div>
  ...
  <section id="problems" class="problems">
    <div class="container">
      ...
      <div class="text-wrap">
        <p class="text">「きっと大丈夫…」<br class="sp">でもちょっと不安</p>
        <p class="text">皆様のその不安や心配</p>
      </div>
    </div>
  </section>
  ...
  <section id="resolve" class="resolve">
    <div class="custom-shape-divider-top-1766230186">
      <svg class="line" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none" aria-hidden="true">
  ...
  <section id="about" class="about">
    <div class="container">
      <img src="./images/woman-with-pc.png" alt="発達支援や相談サービスを行う専門スタッフ" width="1920" height="1080" class="img woman">
      <div class="catch">
        <h2 class="about-title">About Us</h2>
        <p class="about-sub-title">こころ相談研修センターとは</p>
        <img src="./images/SVG/obj-triangle-blue.svg" alt="" class="obj triangle-blue">
      </div>
      
      <div class="text-wrap">
        <div class="text-head">
          <p class="text">お子さま一人ひとりに<br class="sp-600">最適な支援をご提案</p>
          <p class="text"><span class="em">経験豊富な専門家チーム</span>が<br>皆様のお悩みを解決します!</p>
        </div>
        <div class="text-content">
          ...
          <p>
            臨床心理士、公認心理師、言語聴覚士、作業療法士、特別支援教育士、保育士などの発達支援のプロフェッショナルが多数在籍しています。
            お子様一人ひとりの発達段階や特性に合わせた<span class="em">オーダーメイドの支援プログラム</span>をご提供します。
          </p>
          <p class="p-em">専門家チームだからできる多彩なサービスをご提供!!</p>
          <ul class="about-list">
            <li class="list-item">カウンセリング</li>
            <li class="list-item">発達検査・知能検査・性格検査</li>
            <li class="list-item">個別支援計画の作成</li>
            <li class="list-item">訪問支援サービス</li>
            <li class="list-item">放課後等デイサービス</li>
            <li class="list-item">学校園等訪問支援</li>
            <li class="list-item">フリースクール</li>
          </ul>
          <p>カウンセリングから、各種検査、学校園等や行政との連携、安全・安心な居場所支援まで様々なお悩み・不安を解決するための包括的な支援サービスをご提供しております。</p>
        </div>
      </div>
    </div>
  </section>
  <section id="office" class="office">
    <div class="container">
      ...
      <div class="intro">
        <p class="intro-text">地域に寄り添い、お子さまとご家族の「これから」を支えます。<br>放課後等デイサービスからフリースクール、相談支援まで、専門スタッフが連携してお応えします。 <br>各事業所の見学・体験は随時受け付けております。まずはお近くの事業所、または詳細についてお気軽にお問い合わせください。</p>
        
      </div>
      <div class="splide office__splide" aria-label="Splideの基本的なHTML">
        <div class="splide__track">
          <ul class="splide__list">
            ...
            <li class="splide__slide">
              <dl>
                <dt>feel西明石 <span style="color: rgb(255, 95, 95);">&lt;送迎あり&gt;</span></dt>
                <dd>児童発達支援</dd>
                <dd>放課後等デイサービス</dd>
                <dd>保育所等訪問支援</dd>
        ...
        <div class="cards">
          <div class="card">
            ...
            <div class="content">
              ...
              <p class="text">まずはお子さまが安心して通所できるように、好きなこと、得意なことから中心に療育を行います。その後、苦手な部分も養っていけるようなアプローチを少しずつ行います。</p>
              <div class="icon-wrap">
          ...
          <div class="card">
            ...
            <div class="content">
              ...
              <p class="text">保護者様の性格、お子さまの発達特性から、今すぐできる具体的なアドバイスをご提供いたします。ご希望に応じて1家庭につき1度、保護者様の性格特性がわかる心理検査を実施し、お子さまとの関わり方についてご提案させていただきます。</p>
              <div class="icon-wrap">
                <div class="icon">
          ...
          <div class="card">
            ...
            <div class="content">
              ...
              <p class="text">お子さまが普段集団生活を営んでいる学校、子ども園等へ支援員が訪問させていただきます。お子さまの行動観察、お困りごとについて直接支援を行い、集団生活への適応をサポートいたします。</p>
              <div class="icon-wrap">
        ...
        <div class="content-wrap">
          ...
          <div class="item right-top">
            ...
            <ul class="list">
              ...
              <li class="list-item">「できない」ことによる自信喪失や二次障害を防ぎたい</li>
            </ul>
          </div>
  ...
  <section id="program" class="program">
    <div class="container">
      ...
      <div class="inner">
        ...
        <div class="intro">
          <p class="intro-text">一人ひとりの個性に寄り添い、「できる」という自信を未来へ繋ぐ。お子様の発達について、一人で不安を抱えていませんか？私たちは、お子様が本来持っている「可能性」を信じ、遊びや学びを通じて社会で生きる力を育みます。幼児期から学童期、そしてご家族へのサポートまで、切れ目のない包括的な支援プログラムで、ご家族全員の笑顔があふれる毎日を全力で応援します。</p>
        </div>
                    ...
                    <div class="content">
                      ...
                      <ul class="list">
                        <li class="list-item">
                          ...
                          <span class="item">感覚統合療法</span>
                        </li>
                        <li class="list-item">
                          <span class="icon"><i class="fa-solid fa-check"></i></span>
                          <span class="item">言語発達サポート</span>
                        </li>
                        <li class="list-item">
                          <span class="icon"><i class="fa-solid fa-check"></i></span>
                        ...
                        <li class="list-item">
                          <span class="icon"><i class="fa-solid fa-check"></i></span>
                          <span class="item">運動能力向上プログラム</span>
                        </li class="list-item">
                      </ul>
                    </div>
                  </div><!-- /.box -->
                  ...
                  <div class="box">
                    <div class="content">
                      ...
                      <ul class="list">
                        <li class="list-item">
                          <span class="icon"><i class="fa-solid fa-check"></i></span>
                          <span class="item">個別相談会（月2回）</span>
                        </li>
                        <li class="list-item">
                          <span class="icon"><i class="fa-solid fa-check"></i></span>
                          <span class="item">家庭での関わり方ワークショップ</span>
                        </li>
                        <li class="list-item">
                          <span class="icon"><i class="fa-solid fa-check"></i></span>
    ...
    <div class="domains">
      ...
      <div class="domain-wrap">
        <div class="domain first" style="--i:0">
      ...
      <img class="obj square-green" src="./images/SVG/obj-square-green.svg" alt="">
      <img class="obj square-orange" src="./images/SVG/obj-square-orange.svg" alt="">
      <img class="obj square-red" src="./images/SVG/obj-square-red.svg" alt="">
      <img class="obj square-blue" src="./images/SVG/obj-square-blue.svg" alt="">
      <img class="obj square-pink" src="./images/SVG/obj-square-pink.svg" alt="">
    </div>
    ...
    <div class="container">
      <div class="content-wrap">
        <div class="text-wrap">
          ...
          ほんの些細なお悩みでもまずはお話だけという方も。経験豊富な専門の心理士、カウンセラーが親身にご相談に応じます。</p>
          <p>まずはお気軽にご相談ください!</p>
        </div>
        <a class="btn" href="#cta" aria-label="お問い合わせフォームへ移動">ご相談はこちらから</a>
      </div>
      <img class="svg-tri" src="./images/SVG/cv-triangle.svg" alt="">
      <img class="svg-tri svg-tri2" src="./images/SVG/cv-triangle.svg" alt="">
      <img class="svg-tri svg-tri3" src="./images/SVG/cv-triangle.svg" alt="">
      <img class="svg-tri svg-tri4" src="./images/SVG/cv-triangle.svg" alt="">
    </div>
  </section>
  <section id="voice" class="voice">
    <div class="container">
      <div class="catch">
        <h2 class="voice-title">ご利用者様の声</h2>
      </div><!-- /.catch -->
  ...
  <section id="faq" class="faq">
    ...
    <div class="container">
      <div class="catch">
        ...
        <p class="faq-text">ご不明な点はお気軽に<br class="sp">お問い合わせください</p>
      </div><!-- /.catch -->
      <div class="accordion">
        <ul class="accordion-list">
          <li class="accordion-item js-list-item" data-open="closed">
            <button class="accordion-header" aria-expanded="false" aria-controls="faq-a1">
              ...
              <img class="close-icon js-icon" data-open="closed" src="./images/SVG/close_bk.svg" width="36" height="36" alt="" aria-hidden="true"/>
            </button>
          ...
          <li class="accordion-item js-list-item" data-open="closed">
            <button class="accordion-header" aria-expanded="false" aria-controls="faq-a2">
              ...
              <img class="close-icon js-icon" data-open="closed" src="./images/SVG/close_bk.svg" width="36" height="36" alt="" />
            </button>
            <ul id="faq-a2" class="inner-list js-inner-list" data-open="closed" hidden>
              <li class="inner-list-item js-inner-list-item">・まずはお子さまと一緒に当事業所へ見学<br>・通所をご検討いただけましたら市役所に申請書を提出<br>・市役所および弊社との面談<br>・市役所から受給者証の発行<br>・弊社とご契約</li>
            </ul>
          </li>
          <li class="accordion-item js-list-item" data-open="closed">
            ...
            <ul id="faq-a3" class="inner-list js-inner-list" data-open="closed" hidden>
              <li class="inner-list-item js-inner-list-item">feel西明石事業所では送迎サービスを行っております。送迎場所等の詳細については、見学時にご説明させていただきます。</li>
            </ul>
          </li>
          <li class="accordion-item js-list-item" data-open="closed">
  ...
  <section class="cta">
    <div id="cta" class="container">
      <div class="catch">
        ...
        <p class="cta-text">まずは無料相談から始めましょう</p>
      </div><!-- /.catch -->
      <form action="" class="form">
        ...
        <div class="form-group">
          ...
          <input type="email" name="email-check" id="email-check" required autocomplete="email">
        </div><!-- /.form-group -->
        ...
        <div class="form-group">
          <div class="label">
            ...
            <span class="required" style="visibility:hidden" aria-hidden="true">必須</span>
          </div><!-- /.label -->
          <input type="text" name="post" id="post" inputmode="numeric" autocomplete="postal-code">
        </div><!-- /.form-group -->
        ...
        <div class="form-group">
          ...
          <input type="text" name="prefecture" id="prefecture" autocomplete="address-level1">
        </div><!-- /.form-group -->

        <div class="form-group">
          <div class="label">
            <label for="address">市町村区番地/建物名/部屋番号
            </label>
            <span class="required" style="visibility:hidden" aria-hidden="true" autocomplete="street-address">必須</span>
          </div><!-- /.label -->
